...
// // Constants
// const int STEPPER_DELAY_micros = 100;
...
// const int limitSwitchPin = GPIO_NUM_2;  // Limit switch pin, normally closed (HIGH)
// const int dirPin = GPIO_NUM_1;           // DIR pin for A4988
// const int stepPin = GPIO_NUM_0;          // STEP pin for A4988
...
//   delayMicroseconds(STEPPER_DELAY_micros); 
...
//     delayMicroseconds(STEPPER_DELAY_micros/2);
//     stepMotor(100);
//     homeSteps ++;
//     yield();
//   }
...
// void setup() {
//   Serial.begin(460800);
//   Serial.print("Seriallllll plsssss");
